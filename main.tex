...
\input{Chapters/3DandFake}
\input{Chapters/Microsoftlike}
\input{Chapters/Shades}
\input{Chapters/GraphsAndTrees}
\input{Chapters/CoordenadasCartesianas}
\input{Chapters/CircleMagick}
\input{Chapters/EntendendoMedidas}
\input{Chapters/Other}
\input{Chapters/2023.tex}
\input{Chapters/Arquiteturas.tex}
